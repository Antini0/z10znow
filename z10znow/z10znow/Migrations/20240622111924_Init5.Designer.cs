...
namespace z10znow.Migrations
{
    ...
    [Migration("20240622111924_Init5")]
    partial class Init5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("z10znow.Models.Medicament", b =>
                {
            ...
            modelBuilder.Entity("z10znow.Models.Perscription_Medicament", b =>
                {
                    b.Property<int>("IdMedicament")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("z10znow.Models.Perscription_Medicament", b =>
                {
                    b.HasOne("z10znow.Models.Medicament", "Medicament")
                        .WithMany("PerscriptionMedicaments")
                        .HasForeignKey("IdMedicament")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("z10znow.Models.Perscription", "Perscription")
                        .WithMany("PerscriptionMedicaments")
